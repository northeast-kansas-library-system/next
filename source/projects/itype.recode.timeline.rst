...
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|Expected date    | Item count    | itemtype (CODE) | old description | New (CODE) | New description | Print Nonprint |
+=================+===============+=================+=================+============+=================+================+
|February 1,2021  | 31,717        | AUDIOBOOK       | AUDIOBOOK       | NAUD       | Audio book      |  Nonprint      |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|2021             | 823,953       | BOOK            | BOOK            | PBBK       | Book            | Print          |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|November 2020    |               |                 |                 | NGAMBOARD  | Board game      |  Nonprint      |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|February 2021    | 129           | COMPUTER        | PUBLIC USE      | NEQUCOMP   | Public Computer |  Nonprint      |
|                 |               |                 | COMPUTER        |            |                 |                |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|November 2020    | 363           | DIGITAL         | DIGITAL CONTENT | NELEDIG    | Digital Content |  Nonprint      |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
...
|                 |               |                 | TABLET          |            | tablet          |                |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|December 01      | 1,436         | LOCALHOLD       | LOCAL HOLD ONLY | PBBKLHO    | Local requests  | Print          |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|December 01      | 10            | LOCALHOLD2      | LOCAL HOLD BOOK | PBBKLH     | Book (local     | Print          |
|                 |               |                 |                 |            | requests only)  |                |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
...
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|**Done**         |               | NEQUBIKE        | Bicycle         | NEQUBIKE   | Bicycle         |  Nonprint      |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
...
|                 |               |                 | MATERIAL        |            | material        |                |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|December 01      | 1527          | WALKIN          | WALKIN ONLY     | PSPECIAL   | Special         |  Print         |
|                 |               |                 |                 |            | collections     |                |
|                 |               |                 |                 |            | (no requests    |                |
|                 |               |                 |                 |            | allowed)        |                |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|December 01      | 7             | WALKIN2         | WALKIN BOOK     | PBBKWALK   | Book            | Print          |
|                 |               |                 |                 |            | (no requests    |                |
|                 |               |                 |                 |            | allowed)        |                |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
|December 01      | 131           | XXX             | (UNCLASSIFIED)  | PUNC       | (Unclassified)  | Print          |
+-----------------+---------------+-----------------+-----------------+------------+-----------------+----------------+
