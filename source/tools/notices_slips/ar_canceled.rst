...
- Trigger:
    - This notice is sent when an article request is cancelled
...
- General
   ...
   - Module: circulation
   - Code: AR_CANCELED
   - Name: Article Request - Email - Canceled
...
.. code-block:: html
    ...
    <head>
      <title>[% branch.branchname %] - Article Request Canceled</title>
      <!-- Notice code: AR_CANCELED; Library: All; -->
    ...
    <body>
      ...
      <div class="notice">
        ...
        <p>[% branch.branchname %] - Article Request Canceled</p>

        <p>
          Your request for an article from <span style="text-transform: uppercase;">[% biblio.title %]</span> has been canceled for the following reason:<br />
