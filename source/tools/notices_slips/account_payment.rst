...
ACCOUNT_PAYMENT / Account payment / Library payment receipt
===========================================================
...
- Email
   - Type: HTML
   - Message subject: Library payment receipt
...
.. code-block:: html
    ...
    <head>
      <title>[% branch.branchname %] - Account payment</title>
    ...
    <body>
      ...
      <div class="notice">
        ...
        <div id="notice_content">
          ...
          [%- USE Price -%]
          <p>[% branch.branchname %] - Account payment</p>
