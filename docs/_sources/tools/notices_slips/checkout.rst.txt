...
- Trigger:
    - This notice is added to the message queue whenever an item  is checked out to a borrower
...
- Email
   - Type: HTML
   - Message subject: Library Check-out Receipt
